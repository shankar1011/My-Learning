--> We are using semantic UI css library for css it is imported in index.html file
...
LifeCycle Methods:-- 
    ...
    constructor --> Good palce to do one-time setup
    render --> Aviod doing anything besides returning JSX
